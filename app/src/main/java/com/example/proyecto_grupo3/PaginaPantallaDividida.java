...
public class PaginaPantallaDividida extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pagina_pantalla_dividida);

        // Referencia al RecyclerView en el diseño
        recyclerView = findViewById(R.id.recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.addItemDecoration(new SpaceItemDecoration(18)); // Ajusta el espacio de los items del RecyclerView
        ...
        databaseReference.child("data").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (customObject != null && "pantalla partida".equals(customObject.getTipo())) {
                ...
                customListAdapter = new CustomListAdapter(PaginaPantallaDividida.this, dataList);
